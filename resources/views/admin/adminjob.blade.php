...
<div class="container">
  ...
  <table class="table table-bordered table-striped">
    ...
    <tr>
            ...
            <td><a href="{{url('/approveJob',$Job['id'])}}" class="btn btn-success">Approve</a></td>
            <td><a onclick="confirmDelete({{ $Job['id'] }})" class="btn btn-danger">Delete</a></td>
            <!-- <td><a href="{{url('/deleteJob',$Job['id'])}}" class="btn btn-danger">Delete</a></td> -->
    </tr>
...
<script>
    function confirmDelete(userId) {
        ...
        if (confirmed) {
            ...
            window.location.href = "{{ url('deleteJob') }}/" + userId;
        }
    }
</script>
</body>
